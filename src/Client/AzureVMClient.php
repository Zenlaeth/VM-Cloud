...
class AzureVMClient extends AzureClient
{
     ...
     * @return array
     */
    public function createVM( VirtualMachine $machine )
    {
     ...
     * @see createVM()
     */
    public function updateVM(VirtualMachine $machine, $resourceGroup = 'Default')
    {
     ...
     *
     * @param string $name
     * @param VirtualMachine|null $machine
     * @param NetworkInterface $interface
     * @return mixed
     */
    public function createNetworkInterface( $name, VirtualMachine $machine, NetworkInterface $interface, $subscriptionName, $resourceGroupName, $vnetName, $subnetName, $ipName)
    {
        ...
        $interface->addIpConfiguration([
            'name' => $name,
            'properties' => [
                "subnet" => [
                    "id" => "/subscriptions/" . $subscriptionName . "/resourceGroups/" . $resourceGroupName . "/providers/Microsoft.Network/virtualNetworks/" . $vnetName . "/subnets/" . $subnetName
                ],
                "publicIPAddress" => [
                    "id" => "/subscriptions/" . $subscriptionName . "/resourceGroups/" . $resourceGroupName . "/providers/Microsoft.Network/publicIPAddresses/" .  $ipName
                ]
            ]
        ]);
